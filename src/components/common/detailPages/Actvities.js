...
import { ActivityDetailOfUser } from "./UserDetails/activityDetails";
import { CallsDetailsOfUser } from "./UserDetails/callsDetails";
import FilesDetails from "./UserDetails/FilesDetails";
    ...
    <div className="col-xl-9">
      <div className="card mb-3">
        <div className="card-body pb-0 pt-2">
          ...
          {dealPipline && <h4 className="fw-semibold mb-3">Deal Pipelines </h4>}
          {leadStatus && (
      ...
      <div className="tab-content pt-0">
        ...
        {/* Calls */}
        <CallsDetailsOfUser lead_id={id} />
        {/* Files */}
        <FilesDetails type={type} type_id={id} type_name={name} />
        {/* Email */}
