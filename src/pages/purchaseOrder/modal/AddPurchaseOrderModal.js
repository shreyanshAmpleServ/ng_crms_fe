...
import { addPurchaseOrder, fetchPurchaseOrderCode, updatePurchaseOrder } from "../../../redux/purchaseOrder";
...
const handleAvatarChange = (e) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      order ? await dispatch(updatePurchaseOrder( formData))
  ...
  React.useEffect(() => {
        const offcanvasElement = document.getElementById("offcanvas_add_edit_purchase_order");
        if (offcanvasElement) {
