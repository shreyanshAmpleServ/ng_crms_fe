...
align: "center",      width: 50,
 ...
 ;
   ...
   React.useEffect(() => {
      dispatch(fetchCallResults({ search: searchText }));
    }, [dispatch,searchText]);
     React.useEffect(() => {
        setPaginationData({
          currentPage: callResults?.currentPage,
          totalPage: callResults?.totalPages,
          totalCount: callResults?.totalCount,
          pageSize: callResults?.size,
        });
      }, [callResults]);
