...
import { addCallStatus, updateCallStatus } from "../../../../redux/calls"; // Adjust as per your redux actions
import { Link } from "react-router-dom";
import { addCallType, updateCallType } from "../../../../redux/callType";
            ...
            <div className="modal-body">
              ...
              <div className="mb-3">
                <label className="col-form-label">
                  Call Status Name <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
