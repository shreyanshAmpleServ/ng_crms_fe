...
const AddEditModal = ({ mode = "add", initialData = null }) => {
  const { loading } = useSelector((state) => state.industries);
  ...
  const onSubmit = (data) => {
    const closeButton = document.getElementById(
      "close_btn_add_edit_industry_modal"
    );
    if (mode === "add") {
      // Dispatch Add action
      dispatch(
  ...
  return (
    <div className="modal fade" id="add_edit_industry_modal" role="dialog">
        ...
        <div className="modal-content">
          <div className="modal-header">
            ...
            <button
              ...
              aria-label="Close"
              id="close_btn_add_edit_industry_modal"
              onClick={() => {
                reset();
              }}
            >
