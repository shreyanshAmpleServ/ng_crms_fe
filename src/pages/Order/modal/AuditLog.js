...
import { fetchAuditLog } from '../../../redux/order';
import { useDispatch } from 'react-redux';

const OrderAuditLog = ({id}) => {
  ...
  const auditLogData = [
    ...
    },
    {
      ...
      table_name: 'order',
      record_id: 1001,
      column_name: 'order_items.quantity',
      old_value: '10',
      new_value: '15',
      createdby: 2,
  ...
  const { orders ,auditLog, loading, error, success } = useSelector(
    (state) => state.orders,
  );
...
console.log("order",auditLog, orders?.auditLog)
  ...
  return (
    <div className="container  p-1">
      {/* <div className="text-center mb-5">
        ...
        <h3 className="fw-bold">order Activity Timeline</h3>
