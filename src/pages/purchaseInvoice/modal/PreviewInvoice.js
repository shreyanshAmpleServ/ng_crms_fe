  ...
  {order?.status === "L" ? "Closed" : order?.status === "C" ? "Canceled" : order?.status === "P" ? "Pending" : "Open"}
          ...
          <div className="row">
            ...
            <div className="text-break">
                ...
                <div> {order?.purchase_invoice_vendor?.name  || ""}</div>
                <div>{` ${order?.purchase_invoice_vendor?.billing_street  || ""} ${order?.purchase_invoice_vendor?.billing_city || ""}  ${order?.purchase_invoice_vendor?.state?.name  || ""} ${order?.purchase_invoice_vendor?.country?.name || ""}, ${order?.purchase_invoice_vendor?.billing_zipcode || ""}`}</div>
            </div>
            </div>
            {/* <div className="col-md-4 ">
            <div className="">
